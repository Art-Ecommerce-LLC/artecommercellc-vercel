    ...
    <div className="w-full bg-[var(--dark-grey)] min-h-[90vh] flex flex-col justify-center items-center px-4">
      ...
      >
        ...
        <div className="text-white space-y-4">
          ...
          <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Art Ecommerce, LLC, 1500 Halia Court, Encinitas CA, 92024.</p>
          </li>
          <li>
          ...
          <li>
          <p><strong>Website</strong> refers to Art Ecommerce, accessible from <a href="https://www.artecommercellc.com" rel="external nofollow noopener" target="_blank">https://www.artecommercellc.com</a></p>
          </li>
          <li>
          ...
          <ul>
          <li>By email: ben@artecommercellc.com</li>
          </ul>
        </div>
      </motion.div>
    </div>
