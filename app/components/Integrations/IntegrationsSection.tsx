...
export default function IntegrationsSection() {
    ...
    return (
        <div className="w-full bg-black py-16 px-6 lg:px-16 mt-8" ref={integrationsRef}>
            <div className="mx-auto max-w-7xl space-y-12">
                ...
                >
                    <h3 className="text-4xl font-semibold text-white text-center mb-8 tracking-wide">Technology Integrations</h3>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                        ...
                        <motion.a
                            ...
                            className="flex flex-col items-center rounded-lg p-6 shadow-sm transition-shadow hover:shadow-lg bg-black
                              hover:animate-rainbowShadow border-2 border-transparent hover:animate-rainbowBorder"
                        ...
                        <motion.a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-col items-center rounded-lg p-6 shadow-sm transition-shadow hover:shadow-lg
                              hover:animate-rainbowShadow border-2 border-transparent hover:animate-rainbowBorder"
                            whileHover={{ scale: 1.05 }}
                        >
                        ...
                        <motion.a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-col items-center rounded-lg p-6 integration-card"
                            whileHover={{ scale: 1.05 }}
                        >
